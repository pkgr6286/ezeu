    ...
    <div className="flex flex-col">
      <section className="relative w-full h-[300px] md:h-[400px] flex items-center justify-center text-center text-white overflow-hidden">
        ...
        <div className="relative z-20 px-4 md:px-6 max-w-4xl">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight leading-tight">Our Services</h1>
          <p className="mt-4 text-lg md:text-xl">Comprehensive solutions to drive your business forward.</p>
        </div>
      </section>
