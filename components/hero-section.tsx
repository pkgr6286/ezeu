...
export default function HeroSection() {
  return (
    <Link href="/services/devops" className="block w-full">
      <section className="flex w-full h-[550px] md:h-[650px] lg:h-[750px] flex items-center justify-center text-center text-white overflow-hidden px-4 md:px-6 cursor-pointer">
        <Image
