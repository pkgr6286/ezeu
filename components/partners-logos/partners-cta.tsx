  ...
  return (
    <section className="py-12 md:py-24">
      <div className="container mx-auto px-4 md:px-6 text-center max-w-4xl">
        <h2 className="text-3xl md:text-4xl font-bold mb-6 text-ezeu-dark">Interested in Partnering with EZEU?</h2>
        <p className="text-lg md:text-xl text-gray-700 leading-relaxed mb-8">
          We are always looking for strategic alliances and collaborations that drive mutual growth and innovation.
        </p>
        <Link
          href="/contact"
