  ...
  return (
    <section className="relative w-full h-[400px] md:h-[500px] lg:h-[600px] flex items-center justify-center text-center text-white overflow-hidden">
      ...
      <div className="relative z-20 px-4 md:px-6 max-w-4xl">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight leading-tight">DevOps as a Service</h1>
        <p className="mt-4 text-lg md:text-xl">Build. Test. Deploy. Faster. Smarter. Safer.</p>
      </div>
    </section>
  )
}
